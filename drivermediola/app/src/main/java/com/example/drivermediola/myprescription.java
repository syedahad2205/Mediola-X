...
public class myprescription extends AppCompatActivity {
    ...
    private PrescriptionAdapter1 prescriptionAdapter;
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                if(dataSnapshot.getValue() !=null) {
                    for (DataSnapshot snapshot : dataSnapshot.getChildren()) {
                        ...
                        Priscription1 priscription = snapshot.getValue(Priscription1.class);


                        priscriptionList.add(priscription);
                        prescriptionAdapter = new PrescriptionAdapter1(getApplicationContext(), priscriptionList);
