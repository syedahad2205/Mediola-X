...
public class MessageActivity1 extends AppCompatActivity {
    ...
    ImageButton btn_send,btn_addimg;
    EditText text_send;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        toolbar.setNavigationOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                // and this
                startActivity(new Intent(MessageActivity1.this, chatmain1.class).setFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP));
            }
        });
        ...
        btn_send.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (!msg.equals("")){
                    ...
                    Toast.makeText(MessageActivity1.this, "You can't send empty message", Toast.LENGTH_SHORT).show();
                }
                text_send.setText("");
            }
        });
        btn_addimg.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(MessageActivity1.this,Chatimg1.class);
    ...
    private void sendMessage(String sender, final String receiver, String message){
        ...
        reference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                if (notify) {
                    sendNotifiaction(receiver, user.getFname(), msg);
                }
                notify = false;
            }
        ...
        reference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                for (DataSnapshot snapshot : dataSnapshot.getChildren()){
                    ...
                    messageAdapter1 = new MessageAdapter1(MessageActivity1.this, mchat, imageurl);
