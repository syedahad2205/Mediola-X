...
public class PostAdapter extends RecyclerView.Adapter<PostAdapter.ViewHolder> {
    ...
    public DatabaseReference dreference,dreference1,dreference2,dreference3;
    public String like;
    ...
    public void onBindViewHolder(@NonNull PostAdapter.ViewHolder holder, int position) {
        ...
        String imgappbtn="https://firebasestorage.googleapis.com/v0/b/mediola-116c1.appspot.com/o/approvebtn.png?alt=media&token=50c11964-120d-49da-b208-debac814edc0";
        ...
        if(users.getApproved().equals("true"))
        {
            ...
            holder.approveimg.setEnabled(false);
        }
        else
        {
            Glide.with(mContext).load(imgappbtn).into(holder.approveimg);
        }

        holder.approveimg.setOnClickListener(new View.OnClickListener() {
            @Override
                ...
                alertDialog.setMessage("Are you sure you want to approve this post")
                        ...
                        .setPositiveButton("yes", new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialog, int which) {
                                ...
                                dreference3 = FirebaseDatabase.getInstance().getReference("Posts").child(users.getPostid());
                                HashMap<String,Object> data = new HashMap<>();
                                data.put("approved", "true");
                                dreference3.updateChildren(data);
