...
public class myappointment extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        recyclerView = findViewById(R.id.viewbookryc);
        recyclerView.setHasFixedSize(true);
        recyclerView.setLayoutManager(new LinearLayoutManager(getApplicationContext()));
        bookings = new ArrayList<>();
        txtnoapp=findViewById(R.id.noapp);
        txtnoapp.setVisibility(View.VISIBLE);
        txtnoapp.setText("You Don't Have Any Appointment On This Day");
        dateButton.setText(getTodaysDate());
        ...
        DatePickerDialog.OnDateSetListener dateSetListener = new DatePickerDialog.OnDateSetListener()
        {
            ...
            public void onDateSet(DatePicker datePicker, int year, int month, int day)
            {
                ...
                final String id2= fuser.getUid();
                    ...
                    reference = FirebaseDatabase.getInstance().getReference("Bookings").child(id2).child(date2);
                        ...
                        public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                            ...
                            if (dataSnapshot.exists()) {
                                ...
                                for (DataSnapshot snapshot : dataSnapshot.getChildren()) {
                                    ...
                                    bookingsAdapter = new BookingsAdapter(getApplicationContext(), bookings);
